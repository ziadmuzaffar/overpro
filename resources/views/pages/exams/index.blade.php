...
@section('content')
    <form action="{{ route('exams.show') }}" method="get">
        @csrf
        <div class="row">
            <div class="col-sm-4">
                <div class="form-group">
                    <label>الفصل</label>
                    <input type="number" name="chapter" required class="form-control" autocomplete="off" autofocus value="{{ old('chapter') }}" maxlength="1" min="1" max="2">
                    @error('chapter')
